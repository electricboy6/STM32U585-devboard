...
//16436755/1794276/2.50/8/2/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "AT25SF041B-SSHB-B" (originalName "AT25SF041B-SSHB-B")
	...
	(compDef "AT25SF041B-SSHB-B" (originalName "AT25SF041B-SSHB-B") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		)
		...
		(compPin "7" (pinName "__HOLD(IO3)") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "AT25SF041B-SSHB-B"))
		...
		(attr "Mouser Part Number" "988-AT25SF041-SSH-B")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Renesas-Dialog/AT25SF041B-SSHB-B?qs=IS%252B4QmGtzzpXYmyz2tD79g%3D%3D")
		(attr "Manufacturer_Name" "Renesas Electronics")
		(attr "Manufacturer_Part_Number" "AT25SF041B-SSHB-B")
		(attr "Description" "The AT25SF041B is a member of our standard class code and data storage solutions designed for 3V systems in which program code is shadowed from Flash memory into embedded or external RAM for execution.The architecture includes erase block sizes that are optimized to meet the needs of today's code and data storage applications and three security register pages for unique device serialization, system-level Electronic Serial Number (ESN) storage, locked key storage, etc.	Universally compatible pinout and comma")
		(attr "<Hyperlink>" "https://www.renesas.com/us/en/products/memory-logic/non-volatile-memory/spi-nor-flash/dual-quad-spi-memory/at25sf041b-4mbit-27v-minimum-spi-serial-flash-memory-dual-io-support")
		(attr "<Component Height>" "1.75")
		(attr "<STEP Filename>" "AT25SF041B-SSHB-B.stp")
