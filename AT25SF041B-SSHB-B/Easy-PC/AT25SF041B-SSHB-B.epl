...
(library Library_1
	...
	(compDef "AT25SF041B-SSHB-B" (originalName "AT25SF041B-SSHB-B") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		...
		(compPin "7" (pinName "__HOLD(IO3)") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		...
		(attr "Datasheet Link" "https://www.renesas.com/us/en/products/memory-logic/non-volatile-memory/spi-nor-flash/dual-quad-spi-memory/at25sf041b-4mbit-27v-minimum-spi-serial-flash-memory-dual-io-support")
		(attr "Height" "1.75 mm")
	)
